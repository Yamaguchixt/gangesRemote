    ...
    public class expresscheckout  extends HttpServlet {
        ...
        public void doGet(HttpServletRequest request,
            ...
            */
            ...
            String returnURL = "http://localhost:8080/ganges/ReturnURL";
            ...
            '------------------------------------
            */
            String cancelURL = "http://localhost:8080/ganges/jsp/paypal/cance.jsp";
            ...
            */
            ...
            if(strAck !=null && strAck.equalsIgnoreCase("Success"))
            {
                ...
                System.out.println("nvp.get(TOKEN): "+ nvp.get("TOKEN").toString());
